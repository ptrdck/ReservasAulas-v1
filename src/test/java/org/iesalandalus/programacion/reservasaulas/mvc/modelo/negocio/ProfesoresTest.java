...
/*	
	...
	public void constructorCopiaNoValidoTest() {
		...
		try {
			...
			assertEquals("ERROR: No se pueden copiar profesores nulos.", e.getMessage());
	...
	public void insertarNuloTest() {
		...
		try {
			...
			assertEquals("ERROR: No se puede insertar un profesor nulo.", e.getMessage());
			assertEquals(0, profesores.getNumProfesores());
		} catch (OperationNotSupportedException e) {
			fail(ERROR_NO_EXCEPCION);
		}
	...
	public void insertarRepetidoTest() {
		...
		try {
			...
			assertEquals("ERROR: Ya existe un profesor con ese nombre.", e.getMessage());
			assertEquals(1, profesores.getNumProfesores());
		}
	}
	...
	public void borrarNuloTest() {
		...
		try {
			...
			assertEquals("ERROR: No se puede borrar un profesor nulo.", e.getMessage());
			assertEquals(3, profesores.getNumProfesores());
		} catch (OperationNotSupportedException e) {
			fail(ERROR_NO_EXCEPCION);
		}
	...
	public void borrarNoValidoTest() {
		...
		try {
			...
			assertEquals("ERROR: No existe ningún profesor con ese nombre.", e.getMessage());
			assertEquals(3, profesores.getNumProfesores());
		}
	}
	...
	public void buscarNuloTest() {
		...
		try
		{
			...
			assertEquals("ERROR: No se puede buscar un profesor nulo.", e.getMessage());
		}
	}
